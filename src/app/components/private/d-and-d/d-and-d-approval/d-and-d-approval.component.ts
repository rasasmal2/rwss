...
@Component({
  ...
  templateUrl: './d-and-d-approval.component.html',
  styleUrls: ['./d-and-d-approval.component.css']
})
export class DAndDApprovalComponent implements OnInit {
  ...
  onCellClicked(event:any) {
    ...
    let projData:any = localStorage.getItem('d_d_details');
    if(projData) {
